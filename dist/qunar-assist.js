(function (global, factory) {
  ...
  var f$c = descriptors$1 ? $getOwnPropertyDescriptor$2 : function getOwnPropertyDescriptor(O, P) {
  ...
  var f$b = descriptors$1 ? $defineProperty$2 : function defineProperty(O, P, Attributes) {
    anObject$1(O);
    P = toPrimitive$1(P, true);
  ...
  */
  ...
  var Proxy$1 = require('es6-proxy-polyfill');
  ...
  */
  ...
  function _isNativeReflectConstruct() {
    if (typeof Reflect === "undefined" || !Reflect.construct) return false;
    if (Reflect.construct.sham) return false;
    if (typeof Proxy$1 === "function") return true;
